 ...
 */
final class Version20201231191024 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE comic_episode (id VARCHAR(36) NOT NULL, comic_id VARCHAR(36) NOT NULL, title VARCHAR(255) NOT NULL, created_at DATETIME DEFAULT NULL, likes INT DEFAULT 0 NOT NULL, price DOUBLE PRECISION DEFAULT \'0\' NOT NULL, views INT DEFAULT 0 NOT NULL, images LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', published TINYINT(1) DEFAULT \'0\' NOT NULL, INDEX IDX_F9176841D663094A (comic_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
