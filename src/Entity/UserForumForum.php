...
/**
 * @ORM\Entity(repositoryClass=UserForumForumRepository::class)
 */
class UserForumForum
{
    /**
     * @var string
    ...
    /**
     * @ORM\ManyToOne(targetEntity=UserForumCategory::class, inversedBy="forumForum")
     */
    private $Category;
    ...
    /**
     * @ORM\OneToMany(targetEntity=UserForumTopic::class, mappedBy="forum")
