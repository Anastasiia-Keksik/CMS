 ...
 */
final class Version20200605232437 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE forum_post_conversation CHANGE author_id author_id INT DEFAULT NULL, CHANGE solf_delete soft_delete TINYINT(1) NOT NULL');
        ...
        $this->addSql('ALTER TABLE user_forum_post_conversation CHANGE author_id author_id INT DEFAULT NULL, CHANGE solf_delete soft_delete TINYINT(1) NOT NULL');
        $this->addSql('ALTER TABLE user_forum_topic ADD is_it_user_forum_topic TINYINT(1) DEFAULT NULL, CHANGE soft_delete soft_delete TINYINT(1) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE forum_post CHANGE modified_at modified_at DATETIME DEFAULT \'NULL\', CHANGE soft_delete soft_delete TINYINT(1) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE forum_post_conversation CHANGE author_id author_id INT DEFAULT NULL, CHANGE soft_delete solf_delete TINYINT(1) NOT NULL');
        $this->addSql('ALTER TABLE forum_topic CHANGE soft_delete soft_delete TINYINT(1) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE main_menu_category CHANGE user_id user_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE user_forum_post CHANGE modified_at modified_at DATETIME DEFAULT \'NULL\', CHANGE soft_delete soft_delete TINYINT(1) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE user_forum_post_conversation CHANGE author_id author_id INT DEFAULT NULL, CHANGE soft_delete solf_delete TINYINT(1) NOT NULL');
        $this->addSql('ALTER TABLE user_forum_topic DROP is_it_user_forum_topic, CHANGE soft_delete soft_delete TINYINT(1) DEFAULT \'NULL\'');
